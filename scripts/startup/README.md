...
1. **Phía Raspberry Pi 4 (`pi`):**
   - [pi_startup.sh](file:///home/rai/ijat2026/scripts/startup/pi_startup.sh): Shell script thiết lập biến môi trường và chạy `rai_web_api web_api.launch.py`.
...
2. **Phía Jetson Orin Nano (`jetson`):**
   - [jetson_startup.sh](file:///home/rai/ijat2026/scripts/startup/jetson_startup.sh): Shell script thiết lập biến môi trường và chạy `rai_web_api web_api.launch.py`.
