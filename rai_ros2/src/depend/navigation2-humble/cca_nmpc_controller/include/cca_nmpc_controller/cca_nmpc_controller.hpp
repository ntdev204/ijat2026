#ifndef NAV2_CCA_NMPC_CONTROLLER__CCA_NMPC_CONTROLLER_HPP_
#define NAV2_CCA_NMPC_CONTROLLER__CCA_NMPC_CONTROLLER_HPP_
...
#include "ccanmpc_msgs/msg/context.hpp"
#include "ccanmpc_msgs/msg/solver_stats.hpp"
#include "ccanmpc_msgs/msg/adaptive_bounds.hpp"
...
/**
 * @class CCANMPCController
 * @brief Continuous Context-Adaptive Nonlinear Model Predictive Control plugin for Nav2.
 */
class CCANMPCController : public nav2_core::Controller
{
public:
  CCANMPCController() = default;
  ~CCANMPCController() override = default;
...
protected:
  ...
  // CCA-NMPC solver hyperparameters
  double beta_{3.0};
  double d0_{1.5};
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("CCANMPCController")};
  ...
  // Dynamic subscribers
  rclcpp::Subscription<ccanmpc_msgs::msg::HumanStates>::SharedPtr human_states_sub_;
  rclcpp::Subscription<ccanmpc_msgs::msg::Context>::SharedPtr context_sub_;
  ...
  rclcpp_lifecycle::LifecyclePublisher<ccanmpc_msgs::msg::SolverStats>::SharedPtr solver_stats_pub_;
  rclcpp_lifecycle::LifecyclePublisher<ccanmpc_msgs::msg::AdaptiveBounds>::SharedPtr adaptive_bounds_pub_;

  // Callback storage
  ccanmpc_msgs::msg::HumanStates latest_human_states_;
  ccanmpc_msgs::msg::Context latest_context_;
  std::mutex data_mutex_;

  // Callbacks
  void humanStatesCallback(const ccanmpc_msgs::msg::HumanStates::SharedPtr msg);
  void contextCallback(const ccanmpc_msgs::msg::Context::SharedPtr msg);
...
#endif  // NAV2_CCA_NMPC_CONTROLLER__CCA_NMPC_CONTROLLER_HPP_
