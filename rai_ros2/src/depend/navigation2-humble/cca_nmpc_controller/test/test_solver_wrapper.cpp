...
using cca_nmpc_controller::SolverWrapper;
using cca_nmpc_controller::SolveInput;
using cca_nmpc_controller::SolveOutput;
...
std::string locateSolverLibrary()
{
  ...
  try {
    package_prefix = ament_index_cpp::get_package_prefix("cca_nmpc_controller");
