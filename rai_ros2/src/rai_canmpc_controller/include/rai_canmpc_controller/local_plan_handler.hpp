#ifndef NAV2_CANMPC_CONTROLLER__LOCAL_PLAN_HANDLER_HPP_
#define NAV2_CANMPC_CONTROLLER__LOCAL_PLAN_HANDLER_HPP_
...
#endif  // NAV2_CANMPC_CONTROLLER__LOCAL_PLAN_HANDLER_HPP_
