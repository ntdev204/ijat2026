...
def generate_launch_description():
    ...
    my_nav_dir = get_package_share_directory('rai_nav2')
    my_map_dir = os.path.join(my_nav_dir, 'map')
    my_map_file = 'RAI.yaml'
    
    rtabmap_nav_dir = get_package_share_directory('rai_robot_rtab')
    ...
    ld.add_action(rai_lidar)
    ld.add_action(rai_camera)
    #rai_localization
    #ld.add_action(rai_localization)
