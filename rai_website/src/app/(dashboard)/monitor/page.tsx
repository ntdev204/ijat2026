...
function RoutePanel({ busy, nav2Running, routeGoalPose, openRouteSelection, runSelectedRoute, clearRoute, cancelGoal }: RoutePanelProps) {
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Button type="button" className="gap-2" disabled={busy || !nav2Running || !routeGoalPose} onClick={() => void runSelectedRoute()}>
