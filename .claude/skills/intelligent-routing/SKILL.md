...
- **Priority**: CLAUDE.md rules > intelligent-routing
- If CLAUDE.md specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into CLAUDE.md TIER 0 rules.
