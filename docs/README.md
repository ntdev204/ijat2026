...
5. Bật `rai_web_api` trên Pi với `RAI_DEVICE_ROLE=pi`.
6. Bật `rai_web_api` trên Jetson với `RAI_DEVICE_ROLE=jetson`.
...
| Raspberry Pi 4 | `pi` | `http://100.120.77.81:8080` |
| Jetson Orin Nano | `jetson` | `http://100.69.39.18:8080` |
